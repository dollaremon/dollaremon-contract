...
interface IDollaremonRouter02 is IDollaremonRouter01 {
...
contract FeeManager is Ownable{
    ...
    IDollaremonRouter02 public router;
    IBEP20 public rads;
    ...
    function removeLiquidityToToken(address _token) external onlyOwner{
        IDollaremonPair _pair = IDollaremonPair(_token);
    ...
    function setupRouter(address _router) external onlyOwner{
        router = IDollaremonRouter02(_router);
    }
